 ...
 * 
 */
@WebServiceClient(name = "Login", targetNamespace = "http://Chat/", wsdlLocation = "http://localhost:8080/Chat/Login?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOGIN_QNAME = new QName("http://Chat/", "Login");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Chat/Login?wsdl");
    ...
    public Login getLoginPort() {
        return super.getPort(new QName("http://Chat/", "LoginPort"), Login.class);
    }
    ...
    public Login getLoginPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Chat/", "LoginPort"), Login.class, features);
    }
