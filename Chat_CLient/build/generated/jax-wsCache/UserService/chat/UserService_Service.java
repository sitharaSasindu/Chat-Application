 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://Chat/", wsdlLocation = "http://localhost:8080/Chat/UserService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://Chat/", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Chat/UserService?wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://Chat/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Chat/", "UserServicePort"), UserService.class, features);
    }
