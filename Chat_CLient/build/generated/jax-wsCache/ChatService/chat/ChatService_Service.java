 ...
 * 
 */
@WebServiceClient(name = "ChatService", targetNamespace = "http://Chat/", wsdlLocation = "http://localhost:8080/Chat/ChatService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CHATSERVICE_QNAME = new QName("http://Chat/", "ChatService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Chat/ChatService?wsdl");
    ...
    public ChatService getChatServicePort() {
        return super.getPort(new QName("http://Chat/", "ChatServicePort"), ChatService.class);
    }
    ...
    public ChatService getChatServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Chat/", "ChatServicePort"), ChatService.class, features);
    }
